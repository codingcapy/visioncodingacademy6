        ...
        <main class="flex-1 md:pl-20 md:max-w-[1400px]">
            <div class="bg-black text-white md:flex md:pt-20">
                <section class="flex-1 mx-auto md:mx-20 py-10 md:px-10 px-2">
                    <h3 class="timeline-content js--fadeInLeft text-5xl md:text-6xl py-10 pb-2">AP COMPUTER SCIENCE</h3>
                    <h3 class="text-5xl md:text-6xl pb-5"></h3>
                    <p class="timeline-content js--fadeInLeft font-bold underline">Overview:</p>
                    <p class="timeline-content js--fadeInLeft text-lg">Learn Advanced Placement Computer Science with
                        our industry expert instructor and ace your AP CS course!</p>
                    <p class="timeline-content js--fadeInLeft font-bold underline">Prerequisites:</p>
                    <p class="timeline-content js--fadeInLeft text-lg">Algebra I and Cartesian Plane</p>
                </section>
                <section class="flex-1 py-10">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Fundamental Topics</li>
                            <li class="text-lg">Big Ideas</li>
                            <li class="text-lg">Units</li>
                            <li class="text-lg">IDEs</li>
                            <li class="text-lg">Primitive Types</li>
                            <li class="text-lg">Basic Java Syntax</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Assignment Statements</li>
                            <li class="text-lg">Arithmetic Operators</li>
                            <li class="text-lg">Integer Division</li>
                            <li class="text-lg">Precedence</li>
                            <li class="text-lg">Real Numbers</li>
                            <li class="text-lg">Mixing Types</li>
                        </ul>
                        <li class="text-lg">Project:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Lab 1</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Objects: Instances of Classes</li>
                            <li class="text-lg">Class</li>
                            <li class="text-lg">Object</li>
                            <li class="text-lg">Methods and Arguments</li>
                            <li class="text-lg">Constructors</li>
                        </ul>
                        <li class="text-lg">Projects:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Class Diagram Activity</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Overloaded Constructor</li>
                            <li class="text-lg">Reference Data Types</li>
                            <li class="text-lg">Methods</li>
                            <li class="text-lg">Static vs Non-Static</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Modularity</li>
                            <li class="text-lg">Procedural Abstraction</li>
                            <li class="text-lg">Java Visualizer</li>
                        </ul>
                        <li class="text-lg">Projects:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Role Playing in an Object Oriented World</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Overloading Methods</li>
                            <li class="text-lg">Method Tracing</li>
                            <li class="text-lg">Control Flow</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Return Values</li>
                            <li class="text-lg">Return Statements</li>
                            <li class="text-lg">Method Output</li>
                            <li class="text-lg">Getters</li>
                            <li class="text-lg">Strings</li>
                            <li class="text-lg">String Concatenation</li>
                            <li class="text-lg">Escape Sequences</li>
                        </ul>
                        <li class="text-lg">Projects:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Other Useful Methods</li>
                            <li class="text-lg">Wrapper Classes</li>
                            <li class="text-lg">Integer Wrapper Class</li>
                            <li class="text-lg">Double Wrapper Class</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">The Math Class</li>
                            <li class="text-lg">Random Method</li>
                            <li class="text-lg">Math Class Methods</li>
                        </ul>
                        <li class="text-lg">Project:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Math Random Exercise</li>
                        </ul>
                    </ul>
                </section>
            </div>
