        ...
        <main class="flex-1 md:pl-20 md:max-w-[1400px]">
            <div class="bg-black text-white md:flex md:pt-20">
                <section class="flex-1 mx-auto md:mx-20 py-10 md:px-10 px-2">
                    <h3 class="timeline-content js--fadeInLeft text-5xl md:text-6xl py-10 pb-2">ARDUINO & STEM</h3>
                    <h3 class="text-5xl md:text-6xl pb-5"></h3>
                    <p class="timeline-content js--fadeInLeft font-bold underline">Overview:</p>
                    <p class="timeline-content js--fadeInLeft text-lg">Learn to build simple circuits and join exciting science experiments suitable for all ages!</p>
                </section>
                <section class="flex-1 py-10">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Arduino Project: Introduction to Arduino</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Introduction to Arduino and basic components</li>
                            <li class="text-lg">Explanation of what an LED is</li>
                            <li class="text-lg">Basic safety rules</li>
                            <li class="text-lg">Setting up the Arduino board</li>
                            <li class="text-lg">Writing the first program to blink an LED</li>
                        </ul>
                        <li class="text-lg">STEM Research: Virtual Reality (VR)</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Explore the world of VR</li>
                            <li class="text-lg">Get hands-on experience with VR and robotics</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Basic concepts of circuits</li>
                            <li class="text-lg">Connecting an LED to Arduino.</li>
                            <li class="text-lg">Writing a simple program to turn the LED on and off</li>
                        </ul>
                        <li class="text-lg">STEM Research: Block Coding (Scratch)</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Class Activity: Introduce Scratch and basic block coding concepts</li>
                            <li class="text-lg">Home Project: Follow the attached guide and create a simple animation using Scratch. Supervised by parents.</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Using digital pins on Arduino</li>
                            <li class="text-lg">Writing code to control the LED</li>
                            <li class="text-lg">Introduction to basic coding concepts</li>
                        </ul>
                        <li class="text-lg">STEM Research: Plant Growth Basics</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Class Activity: Discuss the basic needs of plants for growth (light, water, soil, etc.) Share your illustrated guide with the class. </li>
                            <li class="text-lg">Experiment: Plant seeds with the terrarium kit. </li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Introduction to buttons and switches.</li>
                            <li class="text-lg">Connecting a button to Arduino. </li>
                            <li class="text-lg">Writing code to turn the LED on and off with a button press.</li>
                        </ul>
                        <li class="text-lg">STEM Research: Buoyancy Basics</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Activity: Experiment with objects that float and sink, discussing density and buoyancy</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Introduction to loops in programming.</li>
                            <li class="text-lg">Writing a simple while loop.</li>
                            <li class="text-lg">Using the while loop to blink an LED continuously.</li>
                        </ul>
                        <li class="text-lg">STEM Research: Building a Water Rocket [ 2 Weeks ]</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Activity: Discuss the principles of pressure and propulsion. Build a simple water rocket</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Creating a sequence of LED blinks</li>
                            <li class="text-lg">Writing a program using the while loop to create a light sequence.</li>
                            <li class="text-lg">Understanding the delay function</li>
                        </ul>
                        <li class="text-lg">STEM Research: Building a Water Rocket [ 2 Weeks ]
                        </li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Activity: Finish building the water rocket and launch it! Boom!</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Combining buttons and while loops</li>
                            <li class="text-lg">Writing a program to control LED sequences with button presses</li>
                            <li class="text-lg">Introduction to more complex code structures</li>
                        </ul>
                        <li class="text-lg">STEM Research: Engineering Basics - Bridge [ Team Project ]</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Activity: Introduction to simple weight structures - demonstration on different weight structures</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Explanation of a seven-segment display</li>
                            <li class="text-lg">Connecting a seven-segment display to Arduino</li>
                            <li class="text-lg">Writing code to display numbers on the seven-segment display</li>
                        </ul>
                        <li class="text-lg">STEM Research: Engineering Basics - Bridge [ Team Project ]</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Activity: Competition day! Whose team built the strongest bridge?</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Writing more advanced code for the seven-segment display</li>
                            <li class="text-lg">Displaying multiple numbers</li>
                            <li class="text-lg">Introduction to functions in Arduino code</li>
                        </ul>
                        <li class="text-lg">STEM Research: Water Filtration [Team Project] </li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Activity: Learn about water filtration - how does it work? Why do we need to filter water? What’s inside the water?</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Introduction to the project: Explain the goal and the components needed.</li>
                            <li class="text-lg">Understanding the seven-segment display: Detailed explanation of how the seven-segment display works and how to control it with Arduino</li>
                            <li class="text-lg">Sketching the circuit: Draw a simple schematic of how the components will be connected.</li>
                            <li class="text-lg">Breakdown of the steps: Divide the project into manageable parts (e.g., connecting the display, writing the code to control the display, adding button functionality)</li>
                        </ul>
                        <li class="text-lg">STEM Research: Exploring Gravity </li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Activity: Build and test a parachute for a small toy using household materials</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Connecting the Seven-Segment Display: Connect the display to the Arduino, ensuring each segment is connected to the appropriate pin. Use resistors to limit the current to the display.</li>
                            <li class="text-lg">Programming the Display: Write a basic Arduino program to display a single digit on the seven-segment display. Expand the code to display a countdown from a preset value (e.g., 10 to 0)</li>
                            <li class="text-lg">Adding Button Functionality: Connect the start, pause, and reset buttons to the Arduino. Write code to handle button presses, starting, pausing, and resetting the countdown</li>
                            <li class="text-lg">Testing and Debugging: Test the circuit and the code to ensure the countdown timer works correctly. Debug any issues that arise and refine the code as needed</li>
                        </ul>
                        <li class="text-lg">STEM Research: Mini Science Fair Preparation</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Activity: Select a topic we learned and develop an experiment. Review topics covered in class (e.g., plant growth, buoyancy, water filtration). Help students select a topic that interests them. Guide students through the scientific method</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Final Testing: Ensure the project works as intended with all components. </li>
                            <li class="text-lg">Decorating the Project: Allow students to decorate their project boards or cases for a personalized touch</li>
                            <li class="text-lg">Presentation Preparation: Teach students how to present their projects, explaining how it works and what they learned</li>
                        </ul>
                        <li class="text-lg">STEM Research: Science Fair Presentation </li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Activity: Each student presents their project to the class</li>
                        </ul>
                    </ul>
                </section>
            </div>
