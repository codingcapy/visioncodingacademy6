        ...
        <main class="flex-1 md:pl-20 md:max-w-[1400px]">
            <div class="bg-black text-white md:flex md:pt-20 px-2">
                <section class="flex-1 mx-auto md:mx-20 py-10 md:px-10">
                    <h3 class="text-5xl md:text-6xl py-10 pb-2">Canadian Computing Competition</h3>
                    <h3 class="text-5xl md:text-6xl pb-5"></h3>
                    <p class="font-bold underline">Overview:</p>
                    <p class="text-lg">This course is a 6-month program focusing on achieving a perfect score in the CCC
                        (Junior).</p>
                </section>
                <section class="flex-1 py-10">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Variables, data types (integers, floats, booleans), basic operators (+,
                                -, *, /, %), reading data from the user (using input() function), printing output (using
                                print() function), if statements, else statements, logical operators (and, or, not), for
                                loops (definite iteration), while loops (indefinite iteration)</li>
                        </ul>
                        ...
                        <ul class="list-disc list-inside pl-7">
                            ...
                            <li class="text-lg">Write programs to prompt the user for input and display messages</li>
                            <li class="text-lg">Format output using string manipulation techniques (e.g., format()
                                function).</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Defining functions with parameters and return values, calling functions,
                                introduction to recursion, base cases, recursive functions (e.g., factorial, Fibonacci
                                sequence)</li>
                        </ul>
                        <li class="text-lg">Practice Problems:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Write programs that use functions to modularize code (e.g., separate
                                functions for calculation and output).</li>
                            <li class="text-lg">Pass arguments to functions and handle return values</li>
                            <li class="text-lg">Write programs that use recursive functions to solve problems (e.g.,
                                calculate factorial, implement binary search).</li>
                            <li class="text-lg">Identify the base case and recursive case in a recursive function</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">String data type, accessing characters, string manipulation functions
                                (e.g., len(), upper(), lower())</li>
                        </ul>
                        <li class="text-lg">Practice Problems:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Write programs to manipulate strings (e.g., counting vowels, reversing a
                                string).</li>
                            <li class="text-lg">Use string slicing to extract substrings</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Understanding and apply two pointers technique</li>
                        </ul>
                        <li class="text-lg">Practice Problems:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Write programs that utilize the two pointers technique to solve problems
                                efficiently</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Introduction to stack and queue data structures, implementing stack and
                                queue operations</li>
                        </ul>
                        <li class="text-lg">Practice Problems:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Write programs to implement stack and queue data structures.</li>
                            <li class="text-lg">Solve problems using stack and queue operations</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Understanding list data structure, list operations</li>
                        </ul>
                        <li class="text-lg">Practice Problems:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Implement list data structure from scratch</li>
                            <li class="text-lg">Perform various list operations such as insertion, deletion, searching,
                                and traversal</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Understanding DFS and BFS algorithms, traversing graphs using DFS and
                                BFS</li>
                        </ul>
                        <li class="text-lg">Practice Problems:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Write programs to implement DFS and BFS algorithms</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Big O notation (introduction - concepts of constant, linear, quadratic
                                time complexity)</li>
                        </ul>
                        <li class="text-lg">Practice Problems:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Analyze the time complexity of simple code snippets (e.g., iterating
                                through an array).</li>
                            <li class="text-lg">Identify the dominant factor affecting time complexity in basic loops.
                            </li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Solve past CCC problems (Junior level) categorized by difficulty.</li>
                        </ul>
                        <li class="text-lg">Practice Problems:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Start with easier problems and gradually progress to harder ones.</li>
                            <li class="text-lg">Pay close attention to problem constraints and edge cases.</li>
                            <li class="text-lg">Analyze different solution approaches and choose the most efficient one.
                            </li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Develop test cases for code and improve debugging skills</li>
                        </ul>
                        <li class="text-lg">Practice Problems:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Write comprehensive test cases to ensure code works for various inputs
                            </li>
                            <li class="text-lg">Use debugging techniques (print statements, debuggers) to identify and
                                fix errors efficiently.</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Focus:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Participate in simulated contests under timed conditions</li>
                        </ul>
                        <li class="text-lg">Practice Activities:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Participate in mock contests with time pressure to simulate the real CCC
                                experience</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Focus:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Review common CCC problem patterns and solution strategies.</li>
                        </ul>
                        <li class="text-lg">Practice Activities:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Identify common problem patterns (e.g., searching, sorting, string
                                manipulation) in past CCC problems.</li>
                            <li class="text-lg">Review and adapt existing solutions to solve similar problems with
