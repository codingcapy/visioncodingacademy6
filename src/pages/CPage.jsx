        ...
        <main class="flex-1 md:pl-20 md:max-w-[1400px]">
            <div class="bg-black text-white md:flex md:pt-20">
                <section class="flex-1 mx-auto md:mx-20 py-10 md:px-10 px-2">
                    ...
                    <p class="timeline-content js--fadeInLeft text-lg">Learn one of the most important and oldest programming languages. As a low-level,
                        or "close-to-the-metal" language, C is in many ways the core and beating heart of programming.
                        Several programming languages are built in, or ontop of C, and you will learn what happens
                        "under the hood" of those languages.</p>
                </section>
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            ...
                            <li class="text-lg">variables, data types (integers, floats, booleans), basic operators (+,
                                -, *, /, %)</li>
                            <li class="text-lg">Reading data from the user and print</li>
                        </ul>
