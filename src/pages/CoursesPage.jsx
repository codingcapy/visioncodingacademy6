    ...
    return (
        <main className="flex-1">
            <div className="bg-black text-white flex flex-col md:w-[1000px] lg:w-[1440px] mx-auto">
                ...
                <section className="md:grid grid-cols-3">
                    ...
                    <div className="timeline-content js--fadeInRight mx-5 md:px-5 md:py-2 rounded-4xl">
                        <a href="./cs.html">
                            <div
                                className="h-[450px] px-5 md:pr-20 py-5 pb-20 bg-black-700 rounded-3xl border-2 border-yellow-200 hover:bg-neutral-600 ease duration-300">
                                <img src="../images/icon69cs.png" alt="course1" className="w-[100px] mx-auto"/>
                    ...
                    <div className="timeline-content js--fadeInRight mx-5 md:px-5 md:py-2 rounded-4xl">
                        <a href="./roblox.html">
                            <div
                                className="h-[450px] px-5 md:pr-20 py-5 pb-20 bg-black-700 rounded-3xl border-2 border-yellow-200 hover:bg-neutral-600 ease duration-300">
                                <img src="../images/icon53vr.png" alt="course1" className="w-[100px] mx-auto mx-center"/>
                    ...
                    <div className="timeline-content js--fadeInRight mx-5 md:px-5 md:py-2 rounded-4xl">
                        <a href="./arduino.html">
                            <div
                                className="h-[450px] px-5 md:pr-20 py-5 pb-20 bg-black-700 rounded-3xl border-2 border-yellow-200 hover:bg-neutral-600 ease duration-300">
                                <img src="../images/icon75arduino.svg" alt="course1"
                    ...
                    <div className="timeline-content js--fadeInRight mx-5 md:px-5 md:py-2 rounded-4xl">
                        <a href="./c.html">
                            <div
                                className="h-[450px] px-5 md:pr-20 py-5 pb-20 bg-black-700 rounded-3xl border-2 border-yellow-200 hover:bg-neutral-600 ease duration-300">
                                <img src="../images/icon71c.png" alt="course1" className="w-[100px] mx-auto"/>
                                    <div className="text-2xl font-bold py-2 text-yellow-200">C</div>
                                    <div className="text-2xl font-bold py-2">Programming Language</div>
                    ...
                    <div className="timeline-content js--fadeInRight mx-5 md:px-5 md:py-2 rounded-4xl">
                        <a href="./cpp.html">
                            <div
                                className="h-[450px] px-5 md:pr-20 py-5 pb-20 bg-black-700 rounded-3xl border-2 border-yellow-200 hover:bg-neutral-600 ease duration-300">
                                <img src="../images/icon70cpp.svg" alt="course1" className="w-[80px] mx-auto"/>
                                    <div className="text-2xl font-bold py-2 text-yellow-200">C++</div>
                                    <div className="text-2xl font-bold py-2">Programming Language</div>
                    ...
                    <div className="timeline-content js--fadeInRight mx-5 md:px-5 md:py-2 rounded-4xl">
                        <a href="./apcs.html">
                            <div
                                className="h-[450px] px-5 md:pr-20 py-5 pb-20 bg-black-700 rounded-3xl border-2 border-yellow-200 hover:bg-neutral-600 ease duration-300">
                                <img src="../images/icon23mind-map.png" alt="course1" className="w-[80px] mx-auto"/>
                    ...
                    <div className="timeline-content js--fadeInRight mx-5 md:px-5 md:py-2 rounded-4xl">
                        <a href="./ccc.html">
                            <div
                                className="h-[450px] px-5 md:pr-20 py-5 pb-20 bg-black-700 rounded-3xl border-2 border-yellow-200 hover:bg-neutral-600 ease duration-300">
                                <img src="../images/icon59hacker.png" alt="course1" className="w-[80px] mx-auto"/>
                ...
                <h1 className="py-10 text-4xl md:text-6xl text-yellow-200 text-center" id="computer-science">Adult
                    Courses</h1>
                <section className="md:grid grid-cols-3">
                    <div className="timeline-content js--fadeInRight mx-5 md:px-5 md:py-2 rounded-4xl">
                        <a href="./comingsoon.html">
                            <div
                                className="h-[450px] px-5 md:pr-20 py-5 pb-20 bg-black-700 rounded-3xl border-2 border-yellow-200 hover:bg-neutral-600 ease duration-300">
                                <img src="../images/icon18teamwork.png" alt="course1" className="w-[100px] mx-auto" />
                    ...
                    <div className="timeline-content js--fadeInRight mx-5 md:px-5 md:py-2 rounded-4xl">
                        <a href="./comingsoon.html">
                            <div
                                className="h-[450px] px-5 md:pr-20 py-5 pb-20 bg-black-700 rounded-3xl border-2 border-yellow-200 hover:bg-neutral-600 ease duration-300">
                                <img src="../images/icon44developer.png" alt="course1" className="w-[100px] mx-auto mx-center" />
                    ...
                    <div className="timeline-content js--fadeInRight mx-5 md:px-5 md:py-2 rounded-4xl">
                        <a href="../courses/comingsoon.html">
                            <div
                                className="h-[450px] px-5 md:pr-20 py-5 pb-20 bg-black-700 rounded-3xl border-2 border-yellow-200 hover:bg-neutral-600 ease duration-300">
                                <img src="../images/devops.jpg" alt="course1" className="w-[150px] mx-auto" />
                    ...
                    <div className="timeline-content js--fadeInRight mx-5 md:px-5 md:py-2 rounded-4xl">
                        <a href="./python.html">
                            <div
                                className="h-[450px] px-5 md:pr-20 py-5 pb-20 bg-black-700 rounded-3xl border-2 border-yellow-200 hover:bg-neutral-600 ease duration-300">
                                <img src="../images/icon7python.png" alt="course1" className="w-[100px] mx-auto mx-center" />
                                <div className="text-2xl font-bold py-2 text-yellow-200">PYTHON BEGINNER</div>
                                <div className="text-2xl font-bold py-2">Programming Language</div>
                                <div className="text-xl font-bold py-2">Beginner-friendly and powerful programming
                                    language used in data science and AI!</div>
                    ...
                    <div className="timeline-content js--fadeInRight mx-5 md:px-5 md:py-2 rounded-4xl">
                        <a href="../courses/webdev.html">
                            <div
                                className="h-[450px] px-5 md:pr-20 py-5 pb-20 bg-black-700 rounded-3xl border-2 border-yellow-200 hover:bg-neutral-600 ease duration-300">
                                <img src="../images/icon39web.png" alt="course1" className="w-[100px] mx-auto" />
                                <div className="text-2xl font-bold py-2 text-yellow-200">WEB DEVELOPMENT</div>
                                <div className="text-2xl font-bold py-2">HTML, CSS and JavaScript</div>
                                <div className="text-xl font-bold py-2">The most popular form of software development -
                                    build, design, and deploy websites and web apps!</div>
