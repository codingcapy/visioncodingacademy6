        ...
        <main class="flex-1 md:pl-20 md:max-w-[1400px]">
            <div class="bg-black text-white md:flex md:pt-20 px-2">
                <section class="flex-1 mx-auto md:mx-20 py-10 md:px-10 px-2">
                    <h3 class="timeline-content js--fadeInLeft text-5xl md:text-6xl py-10 pb-2">INTERMEDIATE PYTHON
                    </h3>
                    <h3 class="text-5xl md:text-6xl pb-5"></h3>
                    <p class="timeline-content js--fadeInLeft font-bold underline">Overview:</p>
                    <p class="timeline-content js--fadeInLeft text-lg">This course assumes the student has learned
                ...
                <div class="py-10 flex-1">
                    <section class="flex-1 py-10">
                        <div class="py-10 ">
                            <h3 class="text-xl text-yellow-400 md:border-l-2 pl-5">Week 1: Python Review and OOP</h3>
                            <img src="../images/icon13pc.png" alt="logo" class="mx-auto md:float-right w-[75px]"/>
                        </div>
                        <ul class="list-disc list-inside pl-2 md:pl-5">
                            <li class="text-lg">Topics:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">Python Fundamentals Review</li>
                                <li class="text-lg">Object-Oriented Programming</li>
                                <li class="text-lg">First Project - User Account System</li>
                            </ul>
                            <li class="text-lg">Project:</li>
                            <ul class="list-disc list-inside pl-7">
                                <li class="text-lg">User Account System</li>
                            </ul>
                        </ul>
                        <div class="py-10 ">
                            <h3 class="text-xl text-yellow-400 md:border-l-2 pl-5">Week 2: User Account System Part 1
                            </h3>
                        ...
                        <ul class="list-disc list-inside pl-2 md:pl-5">
                            <li class="text-lg">Topics:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">User Class</li>
                                <li class="text-lg">Create Users</li>
                                <li class="text-lg">Display Users</li>
                                <li class="text-lg">Delete Users</li>
                            </ul>
                            <li class="text-lg">Project:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">User Account System</li>
                        ...
                        <div class="py-10 ">
                            <h3 class="text-xl text-yellow-400 md:border-l-2 pl-5">User Account System Part 2</h3>
                        ...
                        <ul class="list-disc list-inside pl-2 md:pl-5">
                            <li class="text-lg">Topics:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">Edit Users</li>
                                <li class="text-lg">Save Data</li>
                                <li class="text-lg">Load Data</li>
                            </ul>
                            <li class="text-lg">Project:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">User Account System</li>
                        ...
                        <div class="py-10 ">
                            <h3 class="text-xl text-yellow-400 md:border-l-2 pl-5">Week 4: Pygame Part 1</h3>
                            <img src="../images/icon7python2.png" alt="logo" class="mx-auto md:float-right w-[75px]"/>
                        </div>
                        <ul class="list-disc list-inside pl-2 md:pl-5">
                            <li class="text-lg">Topics:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">Pygame</li>
                                <li class="text-lg">Render the Window</li>
                                <li class="text-lg">Create Main Menu</li>
                            </ul>
                            <li class="text-lg">Project:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">2D Game</li>
                            </ul>
                        </ul>
                        <div class="py-10 ">
                            <h3 class="text-xl text-yellow-400 md:border-l-2 pl-5">Week 5: Pygame Part 2</h3>
                            <img src="../images/icon7python2.png" alt="logo" class="mx-auto md:float-right w-[75px]"/>
                        </div>
                        <ul class="list-disc list-inside pl-2 md:pl-5">
                            <li class="text-lg">Topics:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">Build the game logic</li>
                                <li class="text-lg">Class Player</li>
                                <li class="text-lg">Class World</li>
                            </ul>
                            <li class="text-lg">Project:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">2D Game</li>
                        ...
                        <div class="py-10 ">
                            <h3 class="text-xl text-yellow-400 md:border-l-2 pl-5">Week 6: Pygame Part 3</h3>
                            <img src="../images/icon7python2.png" alt="logo" class="mx-auto md:float-right w-[75px]"/>
                        </div>
                        <ul class="list-disc list-inside pl-2 md:pl-5">
                            <li class="text-lg">Topics:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">Build the game logic part 2</li>
                                <li class="text-lg">Level Mapping</li>
                                <li class="text-lg">Collision Mechanics</li>
                            </ul>
                            <li class="text-lg">Project:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">2D Game</li>
                        ...
                        <div class="py-10 ">
                            <h3 class="text-xl text-yellow-400 md:border-l-2 pl-5">Week 7: Pygame Part 4</h3>
                            <img src="../images/icon7python2.png" alt="logo" class="mx-auto md:float-right w-[75px]"/>
                        </div>
                        <ul class="list-disc list-inside pl-2 md:pl-5">
                            <li class="text-lg">Topics:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">Build the game logic part 3</li>
                                <li class="text-lg">Class Enemy</li>
                                <li class="text-lg">Damage Mechanics</li>
                                <li class="text-lg">Importing Assets</li>
                            </ul>
                            <li class="text-lg">Project:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">2D Game</li>
                        ...
                        <div class="py-10 ">
                            <h3 class="text-xl text-yellow-400 md:border-l-2 pl-5">Week 8: Pygame Part 5</h3>
                            <img src="../images/icon7python2.png" alt="logo" class="mx-auto md:float-right w-[75px]"/>
                        </div>
                        <ul class="list-disc list-inside pl-2 md:pl-5">
                            <li class="text-lg">Topics:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">Animating the Assets</li>
                                <li class="text-lg">Particle Effects</li>
                            </ul>
                            <li class="text-lg">Project:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">2D Game</li>
                        ...
                        <div class="py-10 ">
                            <h3 class="text-xl text-yellow-400 md:border-l-2 pl-5">Week 9: Flask Webserver
                            </h3>
                        ...
                        <ul class="list-disc list-inside pl-2 md:pl-5">
                            <li class="text-lg">Topics:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">Web Server</li>
                                <li class="text-lg">Flask</li>
                                <li class="text-lg">MVC (Model View Controller)</li>
                            </ul>
                            <li class="text-lg">Project:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">Flask Web Server</li>
                            </ul>
                        </ul>
                        <div class="py-10 ">
                            <h3 class="text-xl text-yellow-400 md:border-l-2 pl-5">Week 10: Flask Webserver part 2
                            </h3>
                            <img src="../images/icon17algorithm.png" alt="logo" class="mx-auto md:float-right w-[75px]"/>
                        </div>
                        <ul class="list-disc list-inside pl-2 md:pl-5">
                            <li class="text-lg">Topics:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">Build a Web Server using Flask</li>
                                <li class="text-lg">Databases</li>
                                <li class="text-lg">Postgres and Model</li>
                                <li class="text-lg">Flask Web Server</li>
                            </ul>
                            <li class="text-lg">Project:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                        ...
                        <div class="py-10 ">
                            <h3 class="text-xl text-yellow-400 md:border-l-2 pl-5">Week 11: Flask Webserver part 3
                            </h3>
                            <img src="../images/icon17algorithm.png" alt="logo" class="mx-auto md:float-right w-[75px]"/>
                        </div>
                        <ul class="list-disc list-inside pl-2 md:pl-5">
                            <li class="text-lg">Topics:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">Create</li>
                                <li class="text-lg">Read</li>
                                <li class="text-lg">Update</li>
                                <li class="text-lg">Delete</li>
                            </ul>
                            <li class="text-lg">Project:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">Flask Web Server</li>
                        ...
                        <div class="py-10 ">
                            <h3 class="text-xl text-yellow-400 md:border-l-2 pl-5">Week 12: Review
                            </h3>
                            <img src="../images/icon17algorithm.png" alt="logo" class="mx-auto md:float-right w-[75px]"/>
                        </div>
                        <ul class="list-disc list-inside pl-2 md:pl-5">
                            <li class="text-lg">Topics:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">GitHub and Version Control</li>
                                <li class="text-lg">Recap</li>
                                <li class="text-lg">Introduction to Django</li>
                            </ul>
                            <li class="text-lg">Project:</li>
                            <ul class="list-disc list-inside pl-7 pb-5">
                                <li class="text-lg">Flask Web Server</li>
