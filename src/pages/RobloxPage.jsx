        ...
        <main class="flex-1 md:pl-20 md:max-w-[1400px]">
            <div class="bg-black text-white md:flex md:pt-20">
                <section class="flex-1 mx-auto md:mx-20 py-10 md:px-10 px-2">
                    <h3 class="timeline-content js--fadeInLeft text-5xl md:text-6xl py-10 pb-2">ROBLOX VR</h3>
                    <h3 class="text-5xl md:text-6xl pb-5"></h3>
                    <p class="timeline-content js--fadeInLeft font-bold underline">Overview:</p>
                    <p class="timeline-content js--fadeInLeft text-lg">Suitable for all ages, learn to program roblox
                        and VR!</p>
                </section>
                <section class="flex-1 py-10">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Roblox Studio</li>
                            <li class="text-lg">Move Around the Screen</li>
                            <li class="text-lg">Create My Island</li>
                            <li class="text-lg">Let's Make a Hill</li>
                            <li class="text-lg">Let's Make a Cave</li>
                            <li class="text-lg">Let's Paint a Cave</li>
                            <li class="text-lg">Let's Put a Lightbulb in the Cave</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Shape It To Your Liking</li>
                            <li class="text-lg">Want to Use a Premade Model</li>
                            <li class="text-lg">Also Another Way!</li>
                            <li class="text-lg">Anchoring To The Sky</li>
                            <li class="text-lg">Make Room</li>
                            <li class="text-lg">Make Entrance</li>
                            <li class="text-lg">Decorate Room by Toolbox</li>
                            <li class="text-lg">Make Windows</li>
                            <li class="text-lg">Make Roof</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Make a Door</li>
                            <li class="text-lg">Make a Door Attachment</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Edit Terrain</li>
                            <li class="text-lg">Toolbox</li>
                            <li class="text-lg">Modeling Parts</li>
                            <li class="text-lg">Constraint: Hinge</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Make Fire</li>
                            <li class="text-lg">Make it Brighter</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Waterfall</li>
                        </ul>
                        <li class="text-lg">Projects:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Turntable with Music</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Make Push Button</li>
                            <li class="text-lg">First Scripting!</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Push Button to Open Door</li>
                            <li class="text-lg">Implementing Button Functionality</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Create Proximity Prompt Window</li>
                            <li class="text-lg">Toggle Door</li>
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Attaching Name Tags to Items</li>
                            <li class="text-lg">Creating a Healing Item</li>
                        </ul>
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Creating a Block Like Magic</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Final Project: Hide And Seek 2</li>
                        </ul>
