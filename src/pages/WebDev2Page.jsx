        ...
        <main class="flex-1 md:pl-20 md:max-w-[1400px]">
            <div class="bg-black text-white md:flex md:pt-20">
                <section class="flex-1 mx-auto md:mx-20 py-10 md:px-10 px-2">
                    ...
                    <p class="timeline-content js--fadeInLeft text-lg">Learn front end development with React.js and
                        back end development with Node.js, and become a Full Stack Developer.</p>
                </section>
                <section class="flex-1 py-10">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        ...
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">HTML Review</li>
                            <li class="text-lg">CSS Review</li>
                            <li class="text-lg">JavaScript ES06 Review</li>
                            <li class="text-lg">Introduction to Functional Programming</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">What is React?</li>
                            <li class="text-lg">React using CDN</li>
                            <li class="text-lg">Babel and JSX</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">What is a Bundler?</li>
                            <li class="text-lg">Vite vs Create-React-App (ES Build vs Webpack)</li>
                            <li class="text-lg">Introduction to NPM</li>
                            <li class="text-lg">Installing Node.js for React Bundler</li>
                            <li class="text-lg">Introduction to React Components</li>
                            <li class="text-lg">React Component Props</li>
                        </ul>
                        <li class="text-lg">Project:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Build a React webpage!</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">What is Tailwind?</li>
                            <li class="text-lg">Installing Tailwind</li>
                            <li class="text-lg">Using Tailwind</li>
                            <li class="text-lg">What are React Hooks?</li>
                            <li class="text-lg">Introduction to UseState</li>
                        </ul>
                        <li class="text-lg">Projects:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Style your React webpage using Tailwind!</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Introduction to Zustand</li>
                            <li class="text-lg">Using Zustand</li>
                            <li class="text-lg">What is React Router?</li>
                            <li class="text-lg">Installing and Using React Router</li>
                        </ul>
                        <li class="text-lg">Projects:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Implement Zustand and React Router to your frontend!</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">What is Node.js?</li>
                            <li class="text-lg">Installing Node.js</li>
                            <li class="text-lg">Using Node.js</li>
                        </ul>
                        <li class="text-lg">Projects:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Create a simple Node app!</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">What is a Webserver?</li>
                            <li class="text-lg">Node HTTP Webserver</li>
                            <li class="text-lg">Requests, Responses</li>
                        </ul>
                        <li class="text-lg">Projects:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Build a simple HTTP webserver!</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">What is a database?</li>
                            <li class="text-lg">Relational Database Design</li>
                            <li class="text-lg">Structured Query Language</li>
                            <li class="text-lg">MongoDB</li>
                            <li class="text-lg">PostgreSQL</li>
                        </ul>
                        <li class="text-lg">Projects:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Build your first database!</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">What is Express.js?</li>
                            <li class="text-lg">Using Express.js</li>
                            <li class="text-lg">Single-Threaded Asynchronous Function</li>
                            <li class="text-lg">CRUD operations</li>
                        </ul>
                        <li class="text-lg">Projects:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Build your Express webserver and connect to your database!</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Introduction to Axios</li>
                            <li class="text-lg">Endpoint</li>
                            <li class="text-lg">Loaders and UseEffect</li>
                        </ul>
                        <li class="text-lg">Project:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Integrate your front end and back end!</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Introduction to Authentication</li>
                            <li class="text-lg">JSON Web Token</li>
                            <li class="text-lg">Implementing Auth in the front end</li>
                            <li class="text-lg">Implementing Auth in the back end</li>
                            <li class="text-lg">Integrating Auth in Web Apps</li>
                        </ul>
                        <li class="text-lg">Projects:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Implement Auth in your web app!</li>
                        </ul>
                    </ul>
                    <div class="py-10 ">
                    ...
                    <ul class="list-disc list-inside pl-2 md:pl-5">
                        <li class="text-lg">Topics:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Final Project: Add Comments</li>
                            <li class="text-lg">Review of React and Node</li>
                            <li class="text-lg">Introduction to Web Sockets</li>
                        </ul>
                        <li class="text-lg">Project:</li>
                        <ul class="list-disc list-inside pl-7 pb-5">
                            <li class="text-lg">Final Project</li>
                        </ul>
                    </ul>
                </section>
            </div>
